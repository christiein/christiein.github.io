...
[原文链接](http://design-patterns.readthedocs.io/zh_CN/latest/behavioral_patterns/command.html "原文链接")
...
![结构图](/images/Command.jpg "结构图")

## 4. 时序图

![时序图](/images/seq_Command.jpg "时序图")
...
![运行结果图](/images/Command_run.jpg "运行结果图")
...
![实例图](/images/Command_eg.jpg "实例图")

时序图:

![时序图](/images/seq_Command_eg.jpg "时序图")
